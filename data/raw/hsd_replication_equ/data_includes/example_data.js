...
["practice", "DashedAcceptabilityJudgment", {s: "Bu cümle öncekinden daha çok kelimeye sahip olan okuması daha zor bir cümle olsa da sunum şekli aynıdır." , hasCorrect: 0 } ],
...
["practice", "Form", {
        html: { include: "bias.html" },
        obligatoryCheckboxErrorGenerator: function (field) { return "Deneye devam etmek için onay kutusunu işaretlemesiniz."; }
    } ],
...
[["filler_g", 101], "DashedAcceptabilityJudgment", {s: "Profesörün öğrencisi başarılı olunca mutlu oldular."}],
[["filler_g", 102], "DashedAcceptabilityJudgment", {s: "Çocuğun kedisi dün kaybolunca çılgına döndüler."}],
[["filler_g", 103], "DashedAcceptabilityJudgment", {s: "Ekibin teknisyeni hızlı çalıştığından tekrar çağırdılar."}],
[["filler_g", 104], "DashedAcceptabilityJudgment", {s: "Patronun yemeği yere dökülünce yenisini yaptılar."}],
[["filler_g", 105], "DashedAcceptabilityJudgment", {s: "Yönetmenin filmi kötü çıkınca dizi izlediler."}],
[["filler_g", 106], "DashedAcceptabilityJudgment", {s: "Muhtarın ağacı meyve verince epey şaşırdılar."}],
[["filler_g", 107], "DashedAcceptabilityJudgment", {s: "Köyün öğretmeni emekli olunca saatlerce ağlamışlar."}],
[["filler_g", 108], "DashedAcceptabilityJudgment", {s: "Yaralının ilacı rahatsız edince doktorla konuşmuşlar."}],
[["filler_g", 109], "DashedAcceptabilityJudgment", {s: "Müşterinin yemeği soğuk gelince geri gönderdiler."}],
[["filler_g", 110], "DashedAcceptabilityJudgment", {s: "Grubun menajeri onları duyunca biraz gerildiler."}],
[["filler_g", 111], "DashedAcceptabilityJudgment", {s: "Mahallenin ünlüsü kafeye gelince şok olmuşlar."}],
[["filler_g", 112], "DashedAcceptabilityJudgment", {s: "Tamircinin arabası sorun çıkarınca hemen indiler."}],
[["filler_g", 113], "DashedAcceptabilityJudgment", {s: "Şairin şiiri seyirciler tarafından beğenilmeyince üzüldüler."}],
[["filler_g", 114], "DashedAcceptabilityJudgment", {s: "Dizinin başrolü yanlarına gelince aşırı heyecanlandılar."}],
[["filler_g", 115], "DashedAcceptabilityJudgment", {s: "Zanlının avukatı gelince rahat bir nefes aldılar."}],
[["filler_g", 116], "DashedAcceptabilityJudgment", {s: "Valinin çocuğu kaybolduğu için oldukça endişelenmişler."}],
[["filler_g", 117], "DashedAcceptabilityJudgment", {s: "Köylünün elması kurtlandığı için atmak zorunda kaldılar."}],
[["filler_g", 118], "DashedAcceptabilityJudgment", {s: "Heykeltraşın vazosu kolayca yapıştırılınca yenisini almadılar."}],
[["filler_g", 119], "DashedAcceptabilityJudgment", {s: "Tiyatrocunun saçı yağmurda ıslanınca kurulamaya giriştiler."}],
[["filler_g", 120], "DashedAcceptabilityJudgment", {s: "Komşunun bebeği üstlerine kusunca banyoya koştular."}],
[["filler_g", 121], "DashedAcceptabilityJudgment", {s: "Sekizinci sınıflar ülke ortalamasının çok üstündeler."}],
[["filler_g", 122], "DashedAcceptabilityJudgment", {s: "Çocuklar yeni filmi bensiz izlemeye karar verdiler."}],
[["filler_g", 123], "DashedAcceptabilityJudgment", {s: "Bizi vazgeçirmek için yola bubi tuzağı kurabilirler."}],
[["filler_g", 124], "DashedAcceptabilityJudgment", {s: "Yetkililer havalimanında daha etkili bir yaklaşım benimsediler."}],
[["filler_g", 125], "DashedAcceptabilityJudgment", {s: "Valiler bölge meclislerinin seçimini hep beraber belirlerler."}],
[["filler_g", 126], "DashedAcceptabilityJudgment", {s: "Aslında evde kimse yokken bu kadar şımarmazlar."}],
[["filler_g", 127], "DashedAcceptabilityJudgment", {s: "İnsanlar doğayı mahvederek kendilerine zarar verdiler."}],
[["filler_g", 128], "DashedAcceptabilityJudgment", {s: "Avrupalılar Hindistan'ı ararken yanlışlıkla Avrupa'yı keşfettiler."}],
[["filler_g", 129], "DashedAcceptabilityJudgment", {s: "Bu yöredeki megalitler tapınak inşaası için taşınmış olabilirler."}],
[["filler_g", 130], "DashedAcceptabilityJudgment", {s: "Müttefikler askeri açıdan önemli avantajlara sahiptirler."}],
[["filler_ung", 131], "DashedAcceptabilityJudgment", {s: "Bakanın yardımcısı bulununca koltuk geri getirdi."}],
[["filler_ung", 132], "DashedAcceptabilityJudgment", {s: "Öğrencinin hocası ayrılınca proje birden unuttu."}],
[["filler_ung", 133], "DashedAcceptabilityJudgment", {s: "Pizzacının kuryesi tökezleyince soslar yere saçtı."}],
[["filler_ung", 134], "DashedAcceptabilityJudgment", {s: "Kralın soytarısı asılınca şapka yerinde buldu."}],
[["filler_ung", 135], "DashedAcceptabilityJudgment", {s: "Dekanın davetlisi hapşurunca çaylar aniden düşürdü."}],
[["filler_ung", 136], "DashedAcceptabilityJudgment", {s: "Dedektifin gözlükçüsü evlenince hediyeler ağlanarak verdi."}],
[["filler_ung", 137], "DashedAcceptabilityJudgment", {s: "Politikacının sözcüsü yakalanınca açıklama haliyle kesti."}],
[["filler_ung", 138], "DashedAcceptabilityJudgment", {s: "Kadının temizlikçisi bayılınca deterjan tekrar saçtı."}],
[["filler_ung", 139], "DashedAcceptabilityJudgment", {s: "Mankenin nişanlısı vurulunca haber hızlıca yaydı."}],
[["filler_ung", 140], "DashedAcceptabilityJudgment", {s: "Çobanın sözlüsü tutuklanınca kamera sessizce söktü."}],
[["filler_ung", 141], "DashedAcceptabilityJudgment", {s: "Dansözün kocası varınca kapı sakince açtı."}],
[["filler_ung", 142], "DashedAcceptabilityJudgment", {s: "Çevirmenin kaynanası aramayınca metin keyfince bitirdi."}],
[["filler_ung", 143], "DashedAcceptabilityJudgment", {s: "Fabrikatörün muhasebecisi kovulunca hesap tamamen karıştırdı."}],
[["filler_ung", 144], "DashedAcceptabilityJudgment", {s: "Ünlünün kürkçüsü dönünce kumaş erkenden dikti."}],
[["filler_ung", 145], "DashedAcceptabilityJudgment", {s: "Rektörün yardımcısı atanınca kütüphane gece kapattı."}],
[["filler_ung", 146], "DashedAcceptabilityJudgment", {s: "Şarkıcının taksicisi gecikince trafik aniden kilitledi."}],
[["filler_ung", 147], "DashedAcceptabilityJudgment", {s: "Çocuğun dadısı aramayınca bulaşık saatlerce yıkadı."}],
[["filler_ung", 148], "DashedAcceptabilityJudgment", {s: "Çiftçinin tesisatçısı gelince borular güçlükle söktü."}],
[["filler_ung", 149], "DashedAcceptabilityJudgment", {s: "Çiftin mobilyacısı kızınca koltuk sinirle parçaladı."}],
[["filler_ung", 150], "DashedAcceptabilityJudgment", {s: "Adamın falcısı yanılınca fincan öfkeyle kırdı."}],
[["filler_ung", 151], "DashedAcceptabilityJudgment", {s: "Polisin eve gelmesi çocuğa ansızın söyledi."}],
[["filler_ung", 152], "DashedAcceptabilityJudgment", {s: "Kahvenin para ödemeyince barista arkasından koştu."}],
[["filler_ung", 153], "DashedAcceptabilityJudgment", {s: "Amerika vergiyi reddedince ilk çıkan savaş kazandı."}],
[["filler_ung", 154], "DashedAcceptabilityJudgment", {s: "Film sanatçının aile nefret etmesini anlatıyor."}],
[["filler_ung", 155], "DashedAcceptabilityJudgment", {s: "Restoran sakinleri bina girişi yönlendirmeyi unutmuş"}],
[["filler_ung", 156], "DashedAcceptabilityJudgment", {s: "Usta bir gitarist olduğu hayran olundu."}],
[["filler_ung", 157], "DashedAcceptabilityJudgment", {s: "Trafik ışıkları sürücünün kafasını karıştırmaya denedi."}],
[["filler_ung", 158], "DashedAcceptabilityJudgment", {s: "Ev arkadaşı belki de birine kesin aramış."}],
[["filler_ung", 159], "DashedAcceptabilityJudgment", {s: "Hastaneye varınca doktor hastadan arayıp durmuş."}],
[["filler_ung", 160], "DashedAcceptabilityJudgment", {s: "Yenisine erik reçeli bittiğinden dolayı aranmış."}]
